    ...
    <div class="row-center">
        ...
        <br />
                ...
                <div class="row">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="GetPostDS" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="nid" Width="1040px">
                        <Columns>
